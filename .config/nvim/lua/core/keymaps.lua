...
-- General keymaps
keymap.set({ 'n', 'v' }, '<Space>', '<Nop>', { silent = true }) -- map space in normal and visual to nothing
...
keymap.set("n", "<S-L>", "<C-w>v") -- split window vertically
keymap.set("n", "<S-J>", "<C-h>s") -- split window horizontally
...
-- Buffer Management
keymap.set("n", "<leader>bn", ":bn<CR>") -- Go to next buffer in buffer list
keymap.set("n", "<leader>bm", ":bm<CR>") -- Go to next modified buffer in buffer list
keymap.set("n", "<leader>bp", ":bp<CR>") -- Go to next buffer in buffer list
keymap.set("n", "<leader>bx", ":bun<CR>") -- Close/Unload current buffer
